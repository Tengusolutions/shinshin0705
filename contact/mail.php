...
$site_top = "http://www.shinshin-net.co.jp/";

// 管理者メールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "nagano@shinshin-net.co.jp.test-google-a.com";
...
この度は、ご注文ありがとうございました。
弊社にて御注文を確認次第、御確認いただく為の返信Ｅメールを送信させていただいた後、商品を発送させていただきます。
代金のお支払いは発送後、運賃と共に請求書をご送付申し上げます。
...
──────────────────────
新進漬物株式会社
長野県下高井郡木島平村大字穂高3614-7
TEL:0269-82-2214 FAX:0269-82-3685

URL:http://www.shinshin-net.co.jp/
──────────────────────
...
function mailToAdmin($arr,$subject,$mailFooterDsp,$mailSignature,$encode,$confirmDsp){
	...
	if($confirmDsp != 1){
		$adminBody.="注文ページURL：".@$_SERVER['HTTP_REFERER']."\n";
	}else{
		$adminBody.="注文ページURL：".@$arr['httpReferer']."\n";
	}
